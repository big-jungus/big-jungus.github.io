            ...
            <div className="aboutWrapper">
                ...
                <div>
                    <p className="aboutParagraph">
                        I'm currently a senior at UC Irvine, majoring in Game Design and Interactive Media, with experience in Unity, Unreal, C#, C++, and Python. I find gameplay design and combat design to be really interesting, and have been designing games for a variety of genres. <br/><br/>
                        I've been playing games for as long as I remember, and games have had a huge impact on defining who I am today. Some of my favorite games of all time are Super Mario Galaxy, Chrono Trigger, Slay the Spire, League of Legends, Risk of Rain 2, Noita, and CS:GO!<br/><br/>
